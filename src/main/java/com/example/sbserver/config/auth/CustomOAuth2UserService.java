...
import com.example.sbserver.config.auth.dto.OAuthAttributes;
import com.example.sbserver.config.auth.dto.SessionUser;
import com.example.sbserver.domain.user.User;
import com.example.sbserver.domain.user.UserRepository;
...
/**
 * google 로그인 이후 가져온 사용자의 정보(email, name, picture)들을 기반으로
